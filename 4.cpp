...
void boundaryFill(float x, float y, float* b, float* n) { 
 ...
 if((color[0] != b[0] || color[1] != b[1] || color[2] != b[2]) && (color[0] != n[0] || color[1] != 
...
int main(int argc, char ** argv) { 
 ...
 cout << ("LeŌ Mouse BuƩon: Boundary Fill Right Mouse BuƩon: Flood Fill");
